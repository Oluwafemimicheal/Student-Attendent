  ...
  return (
    <div className='bg-white rounded-lg shadow-lg overflow-hidden w-100'>
      ...
      <form onSubmit={handleSubmit} className='p-5 space-y-4'>
        ...
        <button type='submit' className='flex justify-center items-center w-full p-1.5 bg-blue-900 text-white hover:opacity-90 cursor-pointer transition-all rounded-md'>{isPending ? <div><Spinner /> Loading...</div> : "Login"}</button>
      </form>
      <div className='p-5'>
